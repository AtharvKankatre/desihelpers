    ...
    async onSubmit() {
      ...
      if (p == null) {
        ...
        if (addImages.length > 0) {
          // Fetch existing images count to determine the starting index for new images
          let existingImagesCount =
            formik.values.uploadPhotoOfWork?.length || 0;
          let userId = formik.values.userId;

          let newImagePaths = addImages.map((image, index) => {
          ...
          var uploadResult = await otherServices.uploadImages(
            files,
            newImagePaths
          );
      ...
      <div className="col-md-12">
        <div className={`container p-4 mb-4 ${styles.viewProfileMain}`}>
                  ...
                  p?.jobDetails?.length != 0 ? (
                    ...
                    <>
                      ...
                      {/* <CH6Label
                        ...
                        label="(add at least one skill set to show your service provider card on the map)"
                      /> */}
                    </>
                  )
                }
          ...
          <>
            ...
            {isSeeker ? <CEditAboutMe formik={formik} onLoad={onLoad} /> : null}
